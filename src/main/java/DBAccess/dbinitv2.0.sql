...
INSERT INTO `carport` VALUES (1,'enkelt rejset tag','rejset','betonsten',240,380,250,NULL),(2,'enkelt flat tag','flat','plasttrapez',220,380,250,NULL),(3,'enkest rejset tag med skur','rejset','betonsten',245,490,260,NULL),(4,'enktelt flat tag med skur','flat','plasttrapez',225,490,480,NULL);
...
CREATE TABLE `orders` (
  ...
  KEY `carportid_idx` (`carportid`),
  KEY `customerid_idx` (`customerid`),
  CONSTRAINT `carportid` FOREIGN KEY (`carportid`) REFERENCES `carport` (`carportid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `orders` VALUES (1,1,1,2,6,3),(2,2,2,2,7,4),(3,1,3,2,8,4);
...
-- Dump completed on 2018-05-01 12:25:11
